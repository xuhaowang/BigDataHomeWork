...
public class StripesPMI{
    private static String inputFilePath = "/homework2/medium";
    private static String intermediatePath = "/homework2/StripeIntermediateResult";
    private static String resultPath = "/homework2/Striperesult";
